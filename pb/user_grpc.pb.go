...
type UserServiceClient interface {
	...
	AddUsersBiStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersBiStreamClient, error)
}
...
func (c *userServiceClient) AddUserVerbose(ctx context.Context, in *User, opts ...grpc.CallOption) (UserService_AddUserVerboseClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/UserService/AddUserVerbose", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUsers(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], "/UserService/AddUsers", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUsersBiStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersBiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/UserService/AddUsersBiStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceAddUsersBiStreamClient{stream}
	return x, nil
}

type UserService_AddUsersBiStreamClient interface {
	Send(*User) error
	Recv() (*UserResultStream, error)
	grpc.ClientStream
}

type userServiceAddUsersBiStreamClient struct {
	grpc.ClientStream
}

func (x *userServiceAddUsersBiStreamClient) Send(m *User) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceAddUsersBiStreamClient) Recv() (*UserResultStream, error) {
	m := new(UserResultStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	AddUsersBiStream(UserService_AddUsersBiStreamServer) error
...
func (UnimplementedUserServiceServer) AddUsersBiStream(UserService_AddUsersBiStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method AddUsersBiStream not implemented")
}
...
func _UserService_AddUsersBiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserServiceServer).AddUsersBiStream(&userServiceAddUsersBiStreamServer{stream})
}

type UserService_AddUsersBiStreamServer interface {
	Send(*UserResultStream) error
	Recv() (*User, error)
	grpc.ServerStream
}

type userServiceAddUsersBiStreamServer struct {
	grpc.ServerStream
}

func (x *userServiceAddUsersBiStreamServer) Send(m *UserResultStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceAddUsersBiStreamServer) Recv() (*User, error) {
	m := new(User)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AddUsersBiStream",
			Handler:       _UserService_AddUsersBiStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
